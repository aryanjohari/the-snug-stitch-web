...
export const Women = () => {
  const womens_all = [
    ...
    {
        name: "Regular Fit",
        image: "/images/products/women/regular fit women.jpg"
    },
    {
        name: "Regular Crop Top",
        image: "/images/products/women/crop regular.jpg"
    },
    {
        name: "crop Varsity",
    ...
    },
    {
        ...
        image: "/images/products/women/oversize tshirt crop.jpg"
    },
    {
        name: "Crop hoodie",
        image: "/images/products/women/women crop hoodie.jpg"
    },
    {
        name: "Crop Zipper",
    ...
    },
    {
        ...
        image: "/images/products/women/women oversize hoodie.jpg"
    },
    {
        name: "Oversize Sweatshirt",
        image: "/images/products/women/women oversize sweatshirt.jpg"
    },
    {
        name: "Oversize Dress",
        image: "/images/products/women/women oversize tshirt.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "/images/products/women/women regular sweatshirt.jpg"
    },
    {
        name: "Varsity jacket",
  ...
  <details class="group p-6 [&_summary::-webkit-details-marker]:hidden">
    ...
    <div className="grid grid-cols-5">
      ...
      <div className="my-7 content-center">
            <h2 className="font-bold text-3xl">Womens Collection</h2>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:grid-cols-3">
          {womens_all.map((product) => {
            return (
              <Link to="/contact" className="block group hover:scale-110">
                ...
                <div className="mt-3">
                  ...
                  <p className="mt-1 text-sm text-gray-700">Click to get qoute!</p>
                </div>
              </Link>
            );
          })}
