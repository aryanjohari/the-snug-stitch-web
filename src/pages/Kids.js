...
export const Kids = () => {
  const kids_all = [
    {
        name: "Regular Hoodie",
        image: "/images/products/kids/kids hoodie.jpg"
    },
    {
        name: "Oversized Hoodie",
        image: "/images/products/kids/kids oversize hoodie.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "/images/products/kids/kids oversize.jpg"
    },
    {
        name: "Regular Tshirt",
        image: "/images/products/kids/kids regular.jpg"
    },
    {
        name: "Sweatshirt",
        image: "/images/products/kids/kids sweatshirt.jpg"
    },
    {
        name: "Regular Zipper",
    ...
    <div className="grid grid-cols-5">
      ...
      <div className="sm:grid sm:grid-cols-3  hidden">
        ...
        <div className="my-7 content-center">
          <h2 className="font-bold text-3xl">Kids Collection</h2>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:grid-cols-3">
          {kids_all.map((product) => {
            return (
