...
export const Accessories = () => {
  const accessories_all = [
    {
        name: "Caps",
        image: "/images/products/accessories/cap.jpg"
    },
    {
        name: "Tote Bags",
        image: "/images/products/accessories/totebag.jpg"
    }
  ];
  ...
  <details class="group p-6 [&_summary::-webkit-details-marker]:hidden">
    ...
    <div className="grid grid-cols-5">
      ...
      <div className="sm:grid sm: grid-cols-3  hidden">
          ...
          &#8226; Al Types of Customization available.
          </div>
        ...
        <div className="my-7 content-center">
          <h2 className="font-bold text-3xl">Accessories</h2>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:grid-cols-3">
          {accessories_all.map((product) => {
            return (
